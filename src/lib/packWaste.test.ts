...
describe('излишек упаковок', () => {
  it('меньше пятой части купленного', () => {
    /*
     * До оптимизации было 22.9%: каждый рецепт подбирался сам по себе, и пачка
     * вскрывалась ради ста граммов. Перемерено после того, как расчёт стал
     * единым: 16.3% — фасовка решается один раз на неделю и смешивает размеры,
     * так что запас до порога вырос с двух пунктов до четырёх.
     */
