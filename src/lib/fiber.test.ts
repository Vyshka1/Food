...
describe('подбор держит клетчатку', () => {
  it('дней ниже нормы немного, и провалов нет', () => {
    /*
     * Замер на 280 днях: без учёта клетчатки таких дней 44 и худший день даёт
     * 13 г при норме 26. С весом 16 их 23, худший день 21 г. При прежнем весе
     * 12 их было 32 — полтора дня от порога, то есть без запаса.
     */
