...
const PATHS: Record<IconName, string> = {
  ...
  // «руки заняты» и «присмотр» — две разные цены готовки, и путать их нельзя
  ...
  wallet: 'M4 7.5h13a2 2 0 0 1 2 2V18a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a1.5 1.5 0 0 1 1.5-1.5H16M16 13.5h3',
}
